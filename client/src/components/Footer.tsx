...
import { SiRumble, SiApplepodcasts } from "react-icons/si";
import { Link } from "wouter";
...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    // { id: 7, url: "https://spotify.com/", icon: <FaSpotify className="text-gray-700" /> },
    // { id: 8, url: "https://rumble.com/", icon: <SiRumble className="text-gray-700" /> },
    // { id: 9, url: "https://podcasts.apple.com/", icon: <SiApplepodcasts className="text-gray-700" /> },
  ];
